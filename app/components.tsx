...
export function Brand() {
  return <a href="#inicio" className="brand" aria-label="BEMVI Fisioterapia e Pilates — início"><img src="images/bemvi-logo.webp" width="600" height="198" alt="BEMVI Fisioterapia e Pilates" /></a>;
}
