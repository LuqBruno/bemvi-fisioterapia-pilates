...
export function Brand() {
  return <a href="#inicio" className="brand" aria-label="BEMVI Fisioterapia e Pilates — início"><img src="images/bemvi-logo.webp" width="900" height="255" alt="BEMVI Fisioterapia e Pilates" /></a>;
}
